...
source_suffix = '.rst'
master_doc = 'index'
project = u'Laravel Doctrine ORM'
copyright = u'2024 laraveldoctrine.org'
version = '9'
html_title = "An integration library for Laravel and Doctrine ORM"
html_short_title = "Laravel Doctrine ORM"
...
html_theme_options = {
    ...
    "base_url": "https://docs.orm.laraveldoctrine.org"
